...
function loadtoloader(target, path) {
    ...
    apix.get(path, function(vals) {
        ...
        var xx = '<div style="transform: scale(0.5);transition: all .250s cubic-bezier(0.175, 0.885, 0.32, 1.275)" class="rounded col-4 col-sm-3  pb-2 px-2 text-center miniproduct" data-me=""> \
