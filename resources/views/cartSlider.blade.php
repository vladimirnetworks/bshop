...
<div style="justify-content: center;display: flex;align-items: center;direction:rtl;position:fixed;bottom:0px;left:0px;width:100%;background-color:white;z-index:1001" id="mcartslider" class="text-left cartslider border-top ">
