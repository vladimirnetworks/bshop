...
console.log('called');
   ...
   var cont = $('<div style="width:100%;display:inline-block;border rounded m-2"></div>');
        ...
        countsection.append($("<button class=\"btn btn-danger\">-</button>").on("touchstart click",function() {
          cartchangecount(i,cart[i]['count']-1);
        }));
